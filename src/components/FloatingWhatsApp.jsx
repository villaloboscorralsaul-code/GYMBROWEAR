...
const WA_LINK = 'https://wa.me/19153559631?text=Hola%21%20Me%20interesa%20hacer%20un%20pedido%20mayorista%20de%20Gymbrowear.';
...
export default function FloatingWhatsApp() {
  ...
  useEffect(() => {
    ...
    // También mostrar el label al inicio para que el usuario sepa que está ahí
  ...
  return (
    <a
      ...
      className={`fixed bottom-5 right-4 z-50 flex items-center gap-3 transition-all duration-500 ${
        visible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0 pointer-events-none'
      }`}
    >
      {/* Label — aparece primero */}
      <div
        className={`transition-all duration-400 overflow-hidden whitespace-nowrap ${
      ...
      >
        ...
        <span
          className="absolute inset-0 rounded-full animate-ping"
          style={{ background: 'rgba(37,211,102,0.2)', animationDuration: '2s', animationDelay: '0.5s' }}
        />
        {/* WA Icon */}
